...
public class Main {
    ...
    public static void main(String[] args)
      throws AsyncApiException, ConnectionException, IOException {
        ...
        example.runSample("Contact", "vothanhhung22@gmail.com", "mypasstologin", "mySampleData2.csv");
    }
    ...
    private BulkConnection getBulkConnection(String userName, String password)
        ...
        partnerConfig.setAuthEndpoint("https://hungvo-dev-ed.my.salesforce.com/services/Soap/u/50.0");
